...
const ALL_SCHEMES = [
  ...
  {
    id: 2, name: "PM Fasal Bima Yojana", emoji: "🌦️",
    ministry: "Ministry of Agriculture",
  ...
  {
    id: 4, name: "Ayushman Bharat – PMJAY", emoji: "🏥",
  ...
  {
    id: 5, name: "PM Suraksha Bima Yojana", emoji: "🛡️",
  ...
  {
    id: 7, name: "National Scholarship Portal", emoji: "🎓",
    ...
    documents: ["Aadhaar Card", "Marksheets", "Income Certificate", "Bank Account", "Caste Certificate"],
  ...
  {
    id: 8, name: "Vidya Lakshmi Education Loan", emoji: "📚",
    ministry: "Ministry of Education",
    benefit: "Education loans up to ₹6.5 lakh at subsidized interest rates",
    tag: "Loan", tagColor: "bg-purple-100 text-purple-700 border-purple-200",
    documents: ["Aadhaar Card", "Admission Letter", "Fee Structure", "Income Proof"],
    applyUrl: "https://www.vidyalakshmi.co.in/Students/registerStudent",
    condition: (f: any) => f.occupation === "student",
  },
  {
    id: 9, name: "Divyangjan Scholarship", emoji: "♿",
  ...
  {
    id: 10, name: "MUDRA Yojana – Shishu", emoji: "🏪",
    ministry: "Ministry of Finance",
    benefit: "Loan up to ₹50,000 — no collateral, no guarantor needed",
    tag: "Loan", tagColor: "bg-purple-100 text-purple-700 border-purple-200",
    documents: ["Aadhaar Card", "PAN Card", "Business Address Proof", "Bank Statement"],
    applyUrl: "https://www.mudra.org.in/Home/PMMY",
    condition: (f: any) => f.occupation === "business" || f.occupation === "unemployed",
  },
  {
    id: 11, name: "MUDRA Yojana – Kishore", emoji: "📈",
    ministry: "Ministry of Finance",
    benefit: "Loan ₹50,000 – ₹5 lakh for growing businesses",
    tag: "Loan", tagColor: "bg-purple-100 text-purple-700 border-purple-200",
    documents: ["Aadhaar Card", "PAN Card", "2-year Business Proof", "Bank Statement"],
    applyUrl: "https://www.mudra.org.in/Home/PMMY",
    condition: (f: any) => f.occupation === "business",
  },
  {
    id: 12, name: "Stand Up India – SC/ST/Women", emoji: "💪",
    ministry: "Ministry of Finance",
    benefit: "Loan ₹10 lakh – ₹1 crore for new enterprises",
    tag: "Loan", tagColor: "bg-purple-100 text-purple-700 border-purple-200",
    documents: ["Aadhaar", "PAN", "Business Plan", "SC/ST or Woman proof"],
  ...
  {
    id: 13, name: "PMEGP Self Employment", emoji: "🏭",
    ...
    documents: ["Aadhaar Card", "PAN Card", "8th Pass Certificate", "Project Report"],
    applyUrl: "https://www.kviconline.gov.in/pmegpeportal/pmegphome/index.jsp",
    condition: (f: any) => f.occupation === "business" || f.occupation === "unemployed",
  },
  {
    id: 14, name: "Udyam Registration (MSME)", emoji: "🔖",
    ministry: "Ministry of MSME",
  ...
  {
    id: 15, name: "PM Awas Yojana – Urban", emoji: "🏠",
  ...
  {
    id: 16, name: "PM Awas Yojana – Gramin", emoji: "🏡",
    ministry: "Ministry of Rural Development",
    benefit: "₹1.2–1.3 lakh grant to build a pucca house",
    tag: "Housing", tagColor: "bg-orange-100 text-orange-700 border-orange-200",
    documents: ["Aadhaar Card", "BPL Ration Card", "Land Proof", "Bank Account"],
  ...
  {
    id: 21, name: "MGNREGS – Job Card", emoji: "⛏️",
    ministry: "Ministry of Rural Development",
  ...
  {
    id: 22, name: "Atal Pension Yojana", emoji: "👴",
    ministry: "Ministry of Finance",
  ...
  {
    id: 23, name: "PM Shram Yogi Maandhan", emoji: "🔧",
    ministry: "Ministry of Labour",
  ...
  {
    id: 24, name: "Post-Matric Scholarship SC", emoji: "📖",
    ministry: "Ministry of Social Justice",
    benefit: "Full tuition fee + maintenance allowance for SC students",
    tag: "Scholarship", tagColor: "bg-yellow-100 text-yellow-700 border-yellow-200",
    documents: ["Aadhaar Card", "Caste Certificate", "Marksheets", "Income Certificate", "Bank Account"],
    applyUrl: "https://scholarships.gov.in/fresh/newstdRegfrmInstruction",
    condition: (f: any) => f.category === "sc" && f.occupation === "student",
  },
  {
    id: 25, name: "Post-Matric Scholarship ST", emoji: "🏫",
  ...
  {
    id: 26, name: "Dr. Ambedkar Scholarship OBC", emoji: "🎒",
    ministry: "Ministry of Social Justice",
    benefit: "Tuition fee + maintenance for OBC students in postgrad",
    tag: "Scholarship", tagColor: "bg-yellow-100 text-yellow-700 border-yellow-200",
    documents: ["Aadhaar Card", "OBC Certificate", "Marksheets", "Income Certificate", "Bank Account"],
    applyUrl: "https://scholarships.gov.in/fresh/newstdRegfrmInstruction",
    condition: (f: any) => f.category === "obc" && f.occupation === "student",
  },
  {
    id: 27, name: "PM Kaushal Vikas Yojana", emoji: "🛠️",
  ...
  {
    id: 28, name: "PM Jan Dhan Yojana", emoji: "🏦",
    ministry: "Ministry of Finance",
    benefit: "Zero-balance account + ₹10,000 overdraft + ₹2L accident insurance",
  ...
  {
    id: 29, name: "PM Vishwakarma Yojana", emoji: "⚒️",
    ministry: "Ministry of MSME",
  ...
  {
    id: 30, name: "Mahila Shakti Kendra", emoji: "👩‍💼",
    ministry: "Ministry of Women & Child Development",
    benefit: "Skill development + digital literacy + employment support for women",
    tag: "Skill", tagColor: "bg-pink-100 text-pink-700 border-pink-200",
    documents: ["Aadhaar Card", "Residence Proof"],
    applyUrl: "https://wcd.nic.in/schemes/mahila-shakti-kendra-msk",
    condition: (f: any) => f.gender === "female" && (f.income === "below1L" || f.income === "1to2L"),
  },
];
      ...
      <nav className="bg-white border-b-4 border-[#f97316] shadow-sm sticky top-0 z-20">
        <div className="max-w-3xl mx-auto px-4 py-3 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <button onClick={() => router.push("/home")} className="text-[#1a3a6b] hover:underline text-sm flex items-center gap-1">
              🏠 Home
            </button>
            <span className="text-gray-300">›</span>
            <button onClick={() => router.push("/check")} className="text-[#1a3a6b] hover:underline text-sm">
              Edit Profile
            </button>
            <span className="text-gray-300">›</span>
          ...
          <button
            ...
            className="bg-[#1a3a6b] text-white text-sm px-4 py-2 rounded hover:bg-[#15306b] transition-all"
          >
            🤖 Ask AI
          </button>
        </div>
      ...
      <div className="max-w-3xl mx-auto px-4 py-6">
        ...
        {matched.length > 0 ? (
          <div className="bg-green-50 border border-green-200 rounded-xl p-4 mb-5 flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-green-600 text-sm">
                Click "Apply Now" to go directly to the official government portal
              </div>
            </div>
          </div>
        ) : (
          <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-6 text-center mb-5">
            ...
            <button onClick={() => router.push("/check")} className="mt-3 text-[#1a3a6b] underline text-sm">
              ← Edit your details
            </button>
          </div>
        )}
              ...
              <div className="p-5">
                <div className="flex items-start gap-3 mb-3">
                  ...
                  <div className="flex-1">
                    <div className="font-bold text-[#1a3a6b] text-base leading-tight">
                      {scheme.name}
                    </div>
                    <div className="text-gray-400 text-xs mt-0.5">{scheme.ministry}</div>
                  </div>
                  <span className={`text-xs font-semibold px-2.5 py-1 rounded-full border ${scheme.tagColor}`}>
                    {scheme.tag}
                  </span>
                </div>
              ...
              {expandedId === scheme.id && (
                <div className="border-t border-gray-100 bg-gray-50 px-5 py-4">
                  ...
                  <p className="text-gray-400 text-xs">
                    💡 Tip: Aadhaar + Bank Passbook required for almost all schemes
                  </p>
                </div>
              )}
            </div>
